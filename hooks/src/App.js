...
function App() {
  ...
  },
  {
      id: 2,
      title: 'Creed 2',
      description: "In 1985, Ivan Drago killed Apollo Creed in a tragic boxing match. Under the guidance of Rocky, Apollo's son confronts Drago's son in an ultimate showdown.",
  ...
  },
  {
      id: 3,
      title: 'Robin Hood',
      description: 'Lord Robin of Loxley seeks vengeance after he returns from the Third Crusade to find that the corrupt Sheriff of Nottingham has declared him dead and claimed all his property.',
  ...
  },
  {
    id: 4,
    title: 'Robots',
    description: 'Rodney, a genius inventor, wants to meet his inspiration, Bigweld, who is a master inventor. In order to do so, he travels to the city and finds himself dealing with a corporate honcho.',
